    ...
    <div className="space-y-8">
      ...
      <section className="border-b border-[var(--border-color)] pb-4">
        ...
        <p className="text-xs text-[var(--text-secondary)] tracking-wide">
          Our mission, principles, and the team behind the platform.
        </p>
      </section>

     
      <div className="glass-panel p-6 rounded-xs space-y-4 leading-relaxed text-sm">
        <h3 className="font-serif-heading text-base font-semibold uppercase tracking-wider text-[var(--accent-gold)]">
          Our Mission
        </h3>
      ...
      <div className="glass-panel p-6 rounded-xs space-y-4 leading-relaxed text-sm">
        ...
        <div className="space-y-3">
          <div className="flex gap-3">
            ...
            <div>
              <p className="font-semibold text-[var(--text-primary)]">Report an Item</p>
              <p className="text-[var(--text-secondary)] text-xs mt-0.5">File a detailed report for a lost or found item with category-specific information, images, and contact details.</p>
            </div>
          </div>
          <div className="flex gap-3">
            ...
            <div>
              <p className="font-semibold text-[var(--text-primary)]">Automatic Matching</p>
              <p className="text-[var(--text-secondary)] text-xs mt-0.5">Our matching algorithm cross-references lost and found reports based on category, keywords, location, and item details.</p>
            </div>
          </div>
          <div className="flex gap-3">
            ...
            <div>
              <p className="font-semibold text-[var(--text-primary)]">Get Notified</p>
              <p className="text-[var(--text-secondary)] text-xs mt-0.5">Receive instant notifications when a potential match is found for your report, allowing you to connect and recover your item.</p>
            </div>
          </div>
          <div className="flex gap-3">
            ...
            <div>
              <p className="font-semibold text-[var(--text-primary)]">Community Forum</p>
              <p className="text-[var(--text-secondary)] text-xs mt-0.5">Engage with the community through our discussion forum share notices, safety tips, and success stories.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="glass-panel p-6 rounded-xs space-y-3 text-center">
        <div className="w-16 h-16 mx-auto rounded-full bg-[var(--accent-green)] text-white flex items-center justify-center font-serif-heading font-bold text-2xl">
          BZ
        </div>
        ...
        <div className="flex justify-center gap-4 pt-2 text-[10px] text-[var(--text-secondary)] uppercase tracking-wider">
          <span>Next.js</span>
          <span>•</span>
          <span>Express</span>
          <span>•</span>
